...
const jsonpointer_1 = require("@xliic/common/jsonpointer");
...
class TryItCodelensProvider {
    ...
    provideCodeLenses(document, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (parsed && version === types_1.OpenApiVersion.V3) {
                const oas = parsed;
                const operations = (0, oas30_1.getOperations)(oas);
...
function operationExamplesLens(document, oas, path, method, operation) {
    var _a;
    const result = [];
    const content = (_a = (0, jsonpointer_1.deref)(oas, operation.requestBody)) === null || _a === void 0 ? void 0 : _a.content;
    for (const [mediaType, mediaTypeContent] of Object.entries(content || {})) {
        ...
        if (examples) {
            for (const [name, exampleOrRef] of Object.entries(examples)) {
                ...
                const example = (0, jsonpointer_1.deref)(oas, exampleOrRef);
