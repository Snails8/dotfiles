...
function activate(context, platformContext, cache, configuration, secrets, store, envStore, prefs, auditView, auditContext) {
    let disposables = [];
    const view = new view_1.ScanWebView(context.extensionPath, cache, configuration, secrets, store, envStore, prefs, auditView, auditContext);
