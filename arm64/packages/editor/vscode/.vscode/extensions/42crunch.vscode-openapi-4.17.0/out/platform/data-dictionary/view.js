...
exports.DataDictionaryWebView = void 0;
const vscode = __importStar(require("vscode"));
const web_view_1 = require("../../web-view");
class DataDictionaryWebView extends web_view_1.WebView {
    ...
    sendShowDictionaries(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sendRequest({ command: "showDictionary", payload });
        });
    }
}
exports.DataDictionaryWebView = DataDictionaryWebView;
