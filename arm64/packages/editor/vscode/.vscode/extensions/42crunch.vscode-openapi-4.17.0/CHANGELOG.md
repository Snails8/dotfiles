...
- Fix issue where TryIt woudln't use value defined in parameter's 'example' [#213](https://github.com/42Crunch/vscode-openapi/issues/213)
...
- Fix issue with TryIt failing to display UI [#209](https://github.com/42Crunch/vscode-openapi/issues/209)

## Version 4.16.1 (March 22, 2023)

- Fix issue with extra quotes added by intellisence [#210](https://github.com/42Crunch/vscode-openapi/issues/210)
...
- Fix performance degradation when editing large documents, [#178](https://github.com/42Crunch/vscode-openapi/issues/178)
- Fix attempt to resolve $ref's in staged git changes, [#179](https://github.com/42Crunch/vscode-openapi/issues/179)
- Stop trying to resolve $ref's in non-OpenAPI documents unless the document is referred by other OpenAPI document, [#171](https://github.com/42Crunch/vscode-openapi/issues/171)
...
- Added new command to copy JSON Pointer of the selected item in the outline. See [Issue [#37](https://github.com/42Crunch/vscode-openapi/issues/37)](https://github.com/42Crunch/vscode-openapi/issues/37)
