...
class BaseNode {
    ...
    get parentChildren() {
        var _a, _b;
        return ((_b = (_a = this.parent) === null || _a === void 0 ? void 0 : _a.children) !== null && _b !== void 0 ? _b : []);
    }
    get pos() {
...
export { BaseNode, MirroredReferenceNode, MirroredRegularNode, ReferenceNode, RegularNode, RootNode, SchemaCombinerName, SchemaNodeKind, SchemaTree, isMirroredNode, isReferenceNode, isRegularNode, isRootNode, isSchemaNode };
