...
class PlatformStore {
    ...
    getDataDictionaries() {
        return __awaiter(this, void 0, void 0, function* () {
            const dictionaries = yield (0, api_1.getDataDictionaries)(this.context.connection, this.context.logger);
            const result = [];
            for (const dictionary of dictionaries) {
                const formats = yield (0, api_1.getDataDictionaryFormats)(dictionary.id, this.context.connection, this.context.logger);
                result.push({
                    id: dictionary.id,
