...
class DataDictionaryCompletionProvider {
    ...
    provideCompletionItems(document, position, token, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const completions = formats.map((format) => new vscode.CompletionItem({ label: `${quote}${format.name}${quote}`, description: format.description }, vscode.CompletionItemKind.Value));
            return completions;
        });
    }
}
