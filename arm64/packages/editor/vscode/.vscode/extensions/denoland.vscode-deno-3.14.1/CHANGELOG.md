...
- feat: add support for tasks and test code lens (#436)
  ...
  Checkout out the [testing](https://github.com/denoland/vscode_deno/blob/HEAD/./docs/testing.md) and [tasks](https://github.com/denoland/vscode_deno/blob/HEAD/./docs/tasks.md)
