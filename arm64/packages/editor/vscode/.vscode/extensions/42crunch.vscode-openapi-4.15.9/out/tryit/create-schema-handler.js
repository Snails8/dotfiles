...
function executeCreateSchemaRequest(document, cache, payload) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const schemaNames = new Set(Object.keys((_a = parsed === null || parsed === void 0 ? void 0 : parsed["components"]) === null || _a === void 0 ? void 0 : _a["schemas"]));
        ...
        const schema = { [schemaName]: (0, schema_1.generateSchema)(payload) };
        let text = "";
        ...
        const edit = (0, insert_1.insert)(document, parsed, ["components", "schemas"], text);
        ...
        const location2 = (0, preserving_json_yaml_parser_1.findLocationForPath)(parsed2, ["components", "schemas", schemaName]);
