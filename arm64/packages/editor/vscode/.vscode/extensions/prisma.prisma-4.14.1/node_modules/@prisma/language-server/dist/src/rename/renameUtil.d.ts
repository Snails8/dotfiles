...
export declare function isValidFieldName(currentLine: string, position: Position, currentBlock: Block, document: TextDocument): boolean;
export declare const isBlockName: (position: Position, block: Block, lines: string[], document: TextDocument, blockType: BlockType) => boolean;
export declare function isEnumValue(currentLine: string, position: Position, currentBlock: Block, document: TextDocument): boolean;
 ...
 */
export declare function renameReferencesForFieldValue(currentValue: string, newName: string, document: TextDocument, lines: string[], block: Block, isRelationFieldRename: boolean): TextEdit[];
/**
...
export declare function mapExistsAlready(currentLine: string, lines: string[], block: Block, isModelOrEnumRename: boolean): boolean;
export declare function insertMapAttribute(currentName: string, position: Position, block: Block, isModelOrEnumRename: boolean): TextEdit;
