...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        tryit.activate(context, cache, configuration_1.configuration, context.workspaceState, context.secrets, prefs);
        yield platform.activate(context, auditContext, cache, configuration_1.configuration, platformStore, reportWebView, context.workspaceState, context.secrets, prefs);
        ...
        configuration_1.configuration.onDidChange((e) => __awaiter(this, void 0, void 0, function* () {
            if (configuration_1.configuration.changed(e, "platformUrl") || configuration_1.configuration.changed(e, "platformServices")) {
                platformStore.setCredentials(yield (0, credentials_1.getPlatformCredentials)(configuration_1.configuration, context.secrets));
            }
        }));
    });
