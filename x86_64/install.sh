...
# karabiner の設定
# ======================================================
stow -v -d ~/dotfiles/x86_64/packages/terminal -t ~ alacritty starship tmux iterm2 zshrc fish oh_my_fish thefuck gitconfig Makefile
stow -v -d ~/dotfiles/x86_64/packages/editor -t ~ vimrc vscode
stow -v -d ~/dotfiles/x86_64/packages/window_tool -t ~ yabai
stow -v -d ~/dotfiles/x86_64/packages/keybind -t ~ skhd karabiner
