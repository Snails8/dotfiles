...
`),((n=s.errors[0].params)==null?void 0:n.allowedValues)&&console.log((r=s.errors[0].params)==null?void 0:r.allowedValues),m.default.exit(1)}}async processPaths(){await Promise.all(_.default.map(this.paths,async e=>this.processPath(e)))}async processPath(e){await F.globFiles(e).then(t=>_.default.map(t,n=>W.default.relative(".",n))).then(t=>this.filterFiles(t)).then(this.fulFillFiles).then(t=>this.formatFiles(t))}static globFiles(e){return new Promise((t,n)=>{(0,Ae.default)(e,(r,s)=>r?n(r):t(s))})}async filterFiles(e){if(this.ignoreFile==="")return e;let t=/^\.\.*/,n=_.default.filter(e,a=>t.test(W.default.relative(".",a))),r=_.default.xor(e,n),s=(0,ke.default)().add(this.ignoreFile).filter(r);return _.default.concat(n,s)}static fulFillFiles(e){return this.targetFiles.push(e),Promise.resolve(e)}async formatFiles(e){await Promise.all(_.default.map(e,async t=>this.formatFile(t)))}async formatFile(e){await this.readRuntimeConfig(e),await M(e).then(t=>Promise.resolve(t.toString("utf-8"))).then(t=>new O(this.options).formatContent(t)).then(t=>this.checkFormatted(e,t)).then(t=>this.writeToFile(e,t)).catch(t=>{this.handleError(e,t)})}async checkFormatted(e,t){this.printFormattedOutput(e,t);let n=T.default.readFileSync(e,"utf-8"),r=z(n),s=z(t),a=ue(e,r,s);return this.diffs.push(a),this.outputs.push(t),a.length>0&&((this.options.progress||this.options.write)&&m.default.stdout.write($.default.green("F")),this.options.checkFormatted&&(m.default.stdout.write(`${e}
...
`)}writeToFile(e,t){!this.options.write||this.options.checkFormatted||t.length===0||_.default.isNull(t)||_.default.isEmpty(t)||T.default.writeFile(e,t,n=>{n&&(m.default.stdout.write(`${$.default.red(n.message)}
...
`)))}};async function He(){let l=await(0,Fe.default)((0,We.hideBin)(process.argv)).usage("Usage: $0 [options] [file glob | ...]").example('$0 "resources/views/**/*.blade.php" --write',"Format all files in views directory").option("check-formatted",{alias:"c",type:"boolean",description:"Only checks files are formatted or not",default:!1}).option("write",{alias:"w",type:"boolean",description:"Write to file",default:!1}).option("diff",{alias:"d",type:"boolean",description:"Show diffs",default:!1}).option("end-with-newline",{alias:"e",type:"boolean",description:"End output with newline",default:!0}).option("indent-size",{alias:"i",type:"integer",description:"Indentation size",default:4}).option("wrap-line-length",{alias:"wrap",type:"integer",description:"The length of line wrap size",default:120}).option("wrap-attributes",{alias:"wrap-atts",type:"string",description:"The way to wrap attributes",default:"auto"}).option("sort-tailwindcss-classes",{alias:"sort-classes",type:"boolean",description:"Sort tailwindcss classes",default:!1}).option("progress",{alias:"p",type:"boolean",description:"Print progress",default:!1}).option("stdin",{type:"boolean",description:"format code provided on <STDIN>",default:!1}).option("config",{alias:["runtimeConfigPath"],type:"string",description:"Use this configuration, overriding .bladeformatterrc config options if present",default:null}).option("ignore-path",{alias:["ignoreFilePath"],type:"string",description:"Specify path of ignore file",default:null}).help("h").alias("h","help").epilog("Copyright Shuhei Hayashibara 2019"),e=await Oe.promises.readFile(require.resolve("vscode-oniguruma/release/onig.wasm"));if(await(0,ze.loadWASM)(e.buffer),l.argv.stdin){await process.stdin.pipe((0,je.default)({encoding:"string"},n=>new F(l.argv).format(n).then(r=>{r!==void 0&&process.stdout.write(r)}).catch(r=>{process.stdout.write(`${r.toString()}
`),process.exit(1)})));return}if(l.argv._.length===0){l.showHelp();return}await new F(l.argv,l.argv._).formatFromCLI()}module.exports=Ve(tt);0&&(module.exports={});
