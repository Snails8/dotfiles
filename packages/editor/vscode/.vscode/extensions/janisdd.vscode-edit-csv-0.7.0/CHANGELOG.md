...
## 0.7.0
- fixed issue [#73](https://github.com/janisdd/vscode-edit-csv/issues/73) - changed style to match vs code ones (with webview-ui-toolki)
...
## 0.6.10
- fixed issue [#93](https://github.com/janisdd/vscode-edit-csv/issues/93) - regex search ignored match-case option
...
- added option `openTableAndSelectCellAtCursorPos` to open the table and selected the cell where the cursor was (fixed feature request [#83](https://github.com/janisdd/vscode-edit-csv/issues/83))
	- on by default!
...
- after `reset dat and apply read options` the scroll position and selected cell is restored (issue [#84](https://github.com/janisdd/vscode-edit-csv/issues/84))
...
- fixed issue [#80](https://github.com/janisdd/vscode-edit-csv/issues/80): cell editor is not commited after pressing `ctrl/cmd+s`, so changes are not applied to file

## 0.6.5

- fixed issue [#77](https://github.com/janisdd/vscode-edit-csv/issues/77): Newlines inserted into pasted data (clipboard)
	- fixed via new internal handsontable version

## 0.6.4

- fixed issue [#72](https://github.com/janisdd/vscode-edit-csv/issues/72): copy limited to 1000 cells
	- changed the limit to 10000000

## 0.6.3

- fixed issue [#70](https://github.com/janisdd/vscode-edit-csv/issues/70): Removing columns doesn't remove header
	- undo/redo does not work with column headers

## 0.6.2

- fixed issue [#63](https://github.com/janisdd/vscode-edit-csv/issues/63): column header cells can now be edited
- fixed issue [#66](https://github.com/janisdd/vscode-edit-csv/issues/66): added readonly mode
- fixed issue [#64](https://github.com/janisdd/vscode-edit-csv/issues/64): some non-text keys (e.g. volume controls) not longer clear cell values
...
- fixes issue [#21](https://github.com/janisdd/vscode-edit-csv/issues/21) - past into search widget not working on mac
...
- added option for cell content wrapping (fixes issue [#7](https://github.com/janisdd/vscode-edit-csv/issues/7))
