...
`),c=a.amount/(this.indentCharacter==="	"?4:1),h=o[0],d=this.indentCharacter.repeat(c<0?0:c),p=o.map(y=>d+y);return p[0]=h,`${p.join(`
...
`)}writeToFile(e,t){!this.options.write||this.options.checkFormatted||t.length===0||_.default.isNull(t)||_.default.isEmpty(t)||A.default.writeFile(e,t,n=>{n&&(g.default.stdout.write(`${$.default.red(n.message)}
