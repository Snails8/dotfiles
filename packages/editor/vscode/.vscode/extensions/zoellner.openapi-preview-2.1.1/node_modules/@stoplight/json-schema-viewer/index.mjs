...
const ChildStack = React.memo(({ childNodes, currentNestingLevel, className, RowComponent = SchemaRow }) => {
...
const SchemaRow = React.memo(({ schemaNode, nestingLevel, pl }) => {
    var _a;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Flex, { maxW: "full", pl: pl, py: 2, onMouseEnter: (e) => {
                e.stopPropagation();
            ...
            React.createElement(VStack, { spacing: 1, maxW: "full", flex: 1, ml: isCollapsible && !isRootLevel ? 2 : undefined },
                React.createElement(Flex, { alignItems: "center", maxW: "full", onClick: isCollapsible ? () => setExpanded(!isExpanded) : undefined, cursor: isCollapsible ? 'pointer' : undefined },
                    ...
                    hasProperties && React.createElement(Box, { bg: isHovering ? 'canvas-200' : undefined, h: "px", flex: 1, mx: 3 }),
        ...
        isCollapsible && isExpanded ? (React.createElement(ChildStack, { schemaNode: schemaNode, childNodes: childNodes, currentNestingLevel: nestingLevel })) : null));
});
...
const TopLevelSchemaRow = ({ schemaNode }) => {
    ...
    if (isRegularNode(schemaNode) && isPureObjectNode(schemaNode)) {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(ChildStack, { schemaNode: schemaNode, childNodes: childNodes, currentNestingLevel: nestingLevel })));
    }
    if (isRegularNode(schemaNode) && choices.length > 1) {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            childNodes.length > 0 ? (React.createElement(ChildStack, { schemaNode: schemaNode, childNodes: childNodes, currentNestingLevel: nestingLevel })) : null));
    }
