...
const ChildStack = React__namespace.memo(({ childNodes, currentNestingLevel, className, RowComponent = SchemaRow }) => {
...
const SchemaRow = React__namespace.memo(({ schemaNode, nestingLevel, pl }) => {
    var _a;
    ...
    const isHovering = utils.useAtomValue(isNodeHoveredAtom(schemaNode));
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(mosaic.Flex, { maxW: "full", pl: pl, py: 2, onMouseEnter: (e) => {
                e.stopPropagation();
            ...
            React__namespace.createElement(mosaic.VStack, { spacing: 1, maxW: "full", flex: 1, ml: isCollapsible && !isRootLevel ? 2 : undefined },
                React__namespace.createElement(mosaic.Flex, { alignItems: "center", maxW: "full", onClick: isCollapsible ? () => setExpanded(!isExpanded) : undefined, cursor: isCollapsible ? 'pointer' : undefined },
                    ...
                    hasProperties && React__namespace.createElement(mosaic.Box, { bg: isHovering ? 'canvas-200' : undefined, h: "px", flex: 1, mx: 3 }),
        ...
        isCollapsible && isExpanded ? (React__namespace.createElement(ChildStack, { schemaNode: schemaNode, childNodes: childNodes, currentNestingLevel: nestingLevel })) : null));
});
...
const TopLevelSchemaRow = ({ schemaNode }) => {
    ...
    if (jsonSchemaTree.isRegularNode(schemaNode) && isPureObjectNode(schemaNode)) {
        return (React__namespace.createElement(React__namespace.Fragment, null,
            ...
            React__namespace.createElement(ChildStack, { schemaNode: schemaNode, childNodes: childNodes, currentNestingLevel: nestingLevel })));
    }
    if (jsonSchemaTree.isRegularNode(schemaNode) && choices.length > 1) {
        ...
        return (React__namespace.createElement(React__namespace.Fragment, null,
            ...
            childNodes.length > 0 ? (React__namespace.createElement(ChildStack, { schemaNode: schemaNode, childNodes: childNodes, currentNestingLevel: nestingLevel })) : null));
    }
