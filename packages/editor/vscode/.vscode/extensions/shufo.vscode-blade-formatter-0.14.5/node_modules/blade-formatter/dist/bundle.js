...
`),((n=s.errors[0].params)==null?void 0:n.allowedValues)&&console.log((r=s.errors[0].params)==null?void 0:r.allowedValues),g.default.exit(1)}}async processPaths(){await Promise.all(_.default.map(this.paths,async e=>this.processPath(e)))}async processPath(e){await V.globFiles(e).then(t=>_.default.map(t,n=>O.default.relative(".",n))).then(t=>this.filterFiles(t)).then(this.fulFillFiles).then(t=>this.formatFiles(t))}static globFiles(e){return new Promise((t,n)=>{(0,Te.default)(e,(r,s)=>r?n(r):t(s))})}async filterFiles(e){if(this.ignoreFile==="")return e;let t=/^\.\.*/,n=_.default.filter(e,a=>t.test(O.default.relative(".",a))),r=_.default.xor(e,n),s=(0,ke.default)().add(this.ignoreFile).filter(r);return _.default.concat(n,s)}static fulFillFiles(e){return this.targetFiles.push(e),Promise.resolve(e)}async formatFiles(e){await Promise.all(_.default.map(e,async t=>this.formatFile(t)))}async formatFile(e){await this.readRuntimeConfig(e),await K(e).then(t=>Promise.resolve(t.toString("utf-8"))).then(t=>new F(this.options).formatContent(t)).then(t=>this.checkFormatted(e,t)).then(t=>this.writeToFile(e,t)).catch(t=>{this.handleError(e,t)})}async checkFormatted(e,t){this.printFormattedOutput(e,t);let n=A.default.readFileSync(e,"utf-8"),r=z(n),s=z(t),a=ue(e,r,s);return this.diffs.push(a),this.outputs.push(t),a.length>0&&((this.options.progress||this.options.write)&&g.default.stdout.write(P.default.green("F")),this.options.checkFormatted&&(g.default.stdout.write(`${e}
...
`)}writeToFile(e,t){!this.options.write||this.options.checkFormatted||t.length===0||_.default.isNull(t)||_.default.isEmpty(t)||A.default.writeFile(e,t,n=>{n&&(g.default.stdout.write(`${P.default.red(n.message)}
