...
function registerCommands(context, platformContext, auditContext, store, favorites, importedUrls, cache, provider, tree, reportWebView, scanReportView) {
    const commands = {};
    Object.assign(commands, (0, misc_1.default)(store, favorites, provider, tree));
    Object.assign(commands, (0, util_1.default)(context, platformContext));
    ...
    Object.assign(commands, (0, report_1.default)(store, context, auditContext, cache, reportWebView, scanReportView));
