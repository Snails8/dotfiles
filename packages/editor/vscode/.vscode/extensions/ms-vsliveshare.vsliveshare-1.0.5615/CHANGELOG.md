...
## v1.0.5615
- Add ability to click username in chat window to follow that user
- Fix bug that showed incorrect opened file in status bar tooltip
- Fix bug that prevented file switching to be announced in Accessibility Mode
- Fix bug that showed wrong read-write/read-only access for anonymous users in the status bar and chat window

## 1.0.5449 (March 16, 2022)

## 1.0.5418 (February 28, 2022)

## 1.0.5330 (February 1, 2022)

## 1.0.5273 (January 19, 2022)
- Enable .vsls.json excluded files on web for the parent directory of the shared workspace 

## 1.0.5242 (January 6, 2022)

## 1.0.5201 (January 4, 2022)

## 1.0.5200 (December 16, 2021)

## 1.0.5090 (November 5, 2021)

## 1.0.5065 (October 29, 2021)

## 1.0.5043 (October 22, 2021)

## 1.0.5027 (October 20, 2021)

## 1.0.4991 (October 12, 2021)

## 1.0.4962 (October 5, 2021)
