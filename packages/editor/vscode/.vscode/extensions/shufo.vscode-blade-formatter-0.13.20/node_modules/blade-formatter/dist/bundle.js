...
`)}`:/(@button|@class|@include)/gi.test(a)?i.default.replace(a,/@(button|class|include)(.*)/gis,(h,c,m)=>{var y;let p;if(["button","class"].includes(c)&&(p=80),c==="include"){let C=a.match(/@include\s*?\(\s*?['"](.*?)['"]\s*?/i),k=(y=i.default.nth(C,1))!=null?y:"";p=this.wrapLineLength+`func_inline_for_${c}`.length-r.length-k.length}let g=P(`func_inline_for_${c}${m}`,p,!0).replace(/([\n\s]*)->([\n\s]*)/gs,"->").replace(/,(\s*?\))/gis,(C,k)=>k).trim().trimRight(`
...
`),h=a.length/(this.indentCharacter==="	"?4:1),c=l[0],m=this.indentCharacter.repeat(h<0?0:h),p=l.map(y=>m+y);return p[0]=c,`${n}${p.join(`
`)}`})}restoreTemplatingString(e){return i.default.replace(e,new RegExp(`${this.getTemplatingStringPlaceholder("(\\d+)")}`,"gms"),(t,n)=>this.templatingStrings[n])}restoreStringLiteralInPhp(e){return i.default.replace(e,new RegExp(`${this.getStringLiteralInPhpPlaceholder("(\\d+)")}`,"gms"),(t,n)=>this.stringLiteralInPhp[n])}restoreComponentAttribute(e){return i.default.replace(e,new RegExp(`${this.getComponentAttributePlaceholder("(\\d+)")}`,"gim"),(t,n)=>{var c;let r=this.getComponentAttributePlaceholder(n),s=(c=e.match(new RegExp(`^(.*?)${r}`,"gmi")))!=null?c:[""],a=(0,B.default)(s[0]),l=this.componentAttributes[n],h=i.default.replace(l,/(:{1,2}.*?=)(["'])(.*?)(?=\2)/gis,(m,p,g,y)=>{if(y==="")return m;if(p.startsWith("::"))return`${p}${g}${x.default.js_beautify(y,{wrap_line_length:this.wrapLineLength-a.amount,brace_style:"preserve-inline"}).trim()}`;if(this.isInline(y))try{return`${p}${g}${P(y,this.wrapLineLength-a.amount).trimEnd()}`}catch{return`${p}${g}${y}`}return`${p}${g}${P(y,this.wrapLineLength-a.amount).trimEnd()}`});return`${this.indentComponentAttribute(a.indent,h)}`})}restoreShorthandBinding(e){return i.default.replace(e,new RegExp(`${this.getShorthandBindingPlaceholder("(\\d+)")}`,"gms"),(t,n)=>{var c;let r=this.getShorthandBindingPlaceholder(n),s=(c=e.match(new RegExp(`^(.*?)${r}`,"gmi")))!=null?c:[""],a=(0,B.default)(s[0]),l=this.shorthandBindings[n],h=i.default.replace(l,/(:{1,2}.*?=)(["'])(.*?)(?=\2)/gis,(m,p,g,y)=>{let C={wrap_line_length:this.wrapLineLength-a.amount,brace_style:"preserve-inline"};if(y==="")return m;if(this.isInline(y))try{return`${p}${g}${x.default.js_beautify(y,C).trimEnd()}`}catch{return`${p}${g}${y}`}return`${p}${g}${x.default.js_beautify(y,C).trimEnd()}`});return`${this.indentComponentAttribute(a.indent,h)}`})}async formatAsBlade(e){let t=E(e),n=await new G(this.vsctm,this.oniguruma);return n.createRegistry(e).loadGrammar("text.html.php.blade").then(a=>n.tokenizeLines(t,a)).then(a=>this.formatTokenizedLines(t,a)).catch(a=>{throw a})}formatTokenizedLines(e,t){this.result=[],this.stack=[];for(let n=0;n<e.length;n+=1){let r=e[n],s=t[n];this.processLine(s,r)}return this.result.join(_e.default.EOL)}processLine(e,t){this.processTokenizeResult(e,t)}processKeyword(e){if(i.default.includes(j,e)){i.default.last(this.stack)==="@case"&&e==="@case"&&this.decrementIndentLevel(),e==="@case"&&(this.shouldBeIndent=!0),this.stack.push(e);return}if(i.default.includes(O,e)){if(e==="@break"){this.decrementIndentLevel(),this.stack.pop(),this.stack.push(e);return}if(i.default.last(this.stack)!=="@hassection"){this.stack.pop();return}}if(i.default.includes(re,e)&&(this.shouldBeIndent=!0,this.stack.push(e)),i.default.includes(ne,e)&&i.default.includes(te,i.default.last(this.stack))&&(this.decrementIndentLevel(),this.shouldBeIndent=!0),i.default.includes(v,e)&&(i.default.last(this.stack)==="@section"&&e==="@section"?(this.currentIndentLevel>0&&this.decrementIndentLevel(),this.shouldBeIndent=!0,this.stack.push(e)):(this.shouldBeIndent=!0,this.stack.push(e))),i.default.includes(A,e)){if(e==="@endswitch"&&i.default.last(this.stack)==="@default"){this.decrementIndentLevel(2),this.shouldBeIndent=!1;return}this.decrementIndentLevel(),this.shouldBeIndent=!1,this.stack.pop()}i.default.includes(D,e)&&(this.decrementIndentLevel(),this.shouldBeIndent=!0)}processToken(e,t){if(i.default.includes(e.scopes,"punctuation.definition.comment.begin.blade")&&(this.isInsideCommentBlock=!0),this.argumentCheck){let{count:n,inString:r,stack:s}=this.argumentCheck;if(!r&&t===")"){if(s.push(t),n[t]+=1,n["("]===n[t]){let a=s.join("");oe(a)>=this.argumentCheck.unindentOn&&(this.shouldBeIndent=!1),this.argumentCheck=!1}return}s.push(t),r===t?this.argumentCheck.inString=!1:!r&&(t==='"'||t==="'")&&(this.argumentCheck.inString=t),t==="("&&!r&&(n[t]+=1)}i.default.includes(e.scopes,"punctuation.definition.comment.end.blade")&&(this.isInsideCommentBlock=!1),(t==="{{--"||t.includes("{{--"))&&(this.isInsideCommentBlock=!0),(t==="--}}"||t.includes("--}}"))&&(this.isInsideCommentBlock=!1),!!i.default.includes(e.scopes,"keyword.blade")&&(this.isInsideCommentBlock||(this.processKeyword(t.toLowerCase()),i.default.includes(Object.keys(M),t.toLowerCase())&&(this.argumentCheck={unindentOn:M[t.toLowerCase()],stack:[],inString:!1,count:{"(":0,")":0}})))}processTokenizeResult(e,t){if(this.shouldBeIndent&&(this.incrementIndentLevel(),this.shouldBeIndent=!1),se(e,t)){this.insertFormattedLineToResult(t);return}for(let n=0;n<e.tokens.length;n+=1){let r=e.tokens[n],s=t.substring(r.startIndex,r.endIndex).trim();this.processToken(r,s)}this.insertFormattedLineToResult(t)}insertFormattedLineToResult(e){let n=(0,B.default)(e).amount+this.indentSize*this.currentIndentLevel,r=this.indentCharacter.repeat(n<0?0:n)+e.trim();e.length===0&&this.result.push(e),e.length!==0&&r.length>0&&this.result.push(r),r!==e&&this.diffs.push({original:e,formatted:r})}incrementIndentLevel(e=1){this.currentIndentLevel+=e}decrementIndentLevel(e=1){this.currentIndentLevel-=e}formatJS(e){let t=e,n={js:[],entangle:[]};return Object.keys(n).forEach(r=>{t=t.replace(new RegExp(`@${r}\\((?:[^)(]+|\\((?:[^)(]+|\\([^)(]*\\))*\\))*\\)`,"gs"),s=>{let a=n[r].push(s)-1;return this.getPlaceholder(r,a,s.length)})}),t=x.default.js_beautify(t,{brace_style:"preserve-inline"}),Object.keys(n).forEach(r=>{t=t.replace(new RegExp(this.getPlaceholder(r,"_*(\\d+)"),"gms"),(s,a)=>n[r][a])}),t}};var Pe=u(require("path")),ve=u(require("fs")),be=u(require("ajv")),xe=u(require("find-config")),Xe=new be.default,Be=[".bladeformatterrc.json",".bladeformatterrc"];function Se(o){for(let e=0;e<Be.length;e+=1){let t=(0,xe.default)(Be[e],{cwd:Pe.default.dirname(o),home:!1});if(t)return t}return null}async function Ce(o){if(o===null)return;let e=JSON.parse((await ve.default.promises.readFile(o)).toString()),t={type:"object",properties:{indentSize:{type:"integer",nullable:!0},wrapLineLength:{type:"integer",nullable:!0},wrapAttributes:{type:"string",enum:["auto","force","force-aligned","force-expand-multiline","aligned-multiple","preserve","preserve-aligned"],nullable:!0},endWithNewline:{type:"boolean",nullable:!0},useTabs:{type:"boolean",nullable:!0}},additionalProperties:!0},n=Xe.compile(t);if(!n(e))throw n;return e}var H=class extends Error{};var K=class{constructor(e={},t=[]){this.currentTargetPath=".",this.paths=t,this.options=e,this.targetFiles=[],this.errors=[],this.diffs=[],this.outputs=[],this.formattedFiles=[],this.ignoreFile="",this.fulFillFiles=[],this.targetFiles=[],this.runtimeConfigCache={}}async format(e,t={}){let n=this.options||t;return await this.readIgnoreFile(d.default.cwd()),await this.readRuntimeConfig(d.default.cwd()),new I(n).formatContent(e).catch(r=>{throw new H(r)})}async formatFromCLI(){try{this.printPreamble(),await this.readIgnoreFile(d.default.cwd()),await this.processPaths(),this.printResults()}catch{}}fileExists(e){return R.default.promises.access(e,R.default.constants.F_OK).then(()=>!0).catch(()=>!1)}async readIgnoreFile(e){let t=".bladeignore",n,r=F.default.dirname(e);if(this.options.ignoreFilePath?n=this.options.ignoreFilePath:n=(0,Le.default)(t,{cwd:r}),!!n)try{this.ignoreFile=(await R.default.promises.readFile(n)).toString()}catch{}}async readRuntimeConfig(e){var n,r;f.default.isEmpty(this.runtimeConfigCache)&&(this.options=f.default.merge(this.options,this.runtimeConfigCache));let t;if(this.options.runtimeConfigPath?t=this.options.runtimeConfigPath:t=Se(e),!f.default.isNull(t))try{let s=await Ce(t);this.options=f.default.merge(this.options,s),this.runtimeConfigCache=this.options}catch(s){s instanceof SyntaxError&&(d.default.stdout.write(w.default.red.bold(`
Blade Formatter JSON Syntax Error: 

`)),d.default.stdout.write(q.default.format(s)),d.default.exit(1)),d.default.stdout.write(w.default.red.bold(`
Blade Formatter Config Error: ${F.default.basename(t)}

`)),d.default.stdout.write(`\`${s.errors[0].instancePath.replace("/","")}\` ${s.errors[0].message}

`),((n=s.errors[0].params)==null?void 0:n.allowedValues)&&console.log((r=s.errors[0].params)==null?void 0:r.allowedValues),d.default.exit(1)}}async processPaths(){await Promise.all(f.default.map(this.paths,async e=>this.processPath(e)))}async processPath(e){await K.globFiles(e).then(t=>f.default.map(t,n=>F.default.relative(".",n))).then(t=>this.filterFiles(t)).then(this.fulFillFiles).then(t=>this.formatFiles(t))}static globFiles(e){return new Promise((t,n)=>{(0,Re.default)(e,(r,s)=>r?n(r):t(s))})}async filterFiles(e){if(this.ignoreFile==="")return e;let t=/^\.\.*/,n=f.default.filter(e,a=>t.test(F.default.relative(".",a))),r=f.default.xor(e,n),s=(0,Ie.default)().add(this.ignoreFile).filter(r);return f.default.concat(n,s)}static fulFillFiles(e){return this.targetFiles.push(e),Promise.resolve(e)}async formatFiles(e){await Promise.all(f.default.map(e,async t=>this.formatFile(t)))}async formatFile(e){await this.readRuntimeConfig(e),await X(e).then(t=>Promise.resolve(t.toString("utf-8"))).then(t=>new I(this.options).formatContent(t)).then(t=>this.checkFormatted(e,t)).then(t=>this.writeToFile(e,t)).catch(t=>{this.handleError(e,t)})}async checkFormatted(e,t){this.printFormattedOutput(e,t);let n=R.default.readFileSync(e,"utf-8"),r=E(n),s=E(t),a=he(e,r,s);return this.diffs.push(a),this.outputs.push(t),a.length>0&&((this.options.progress||this.options.write)&&d.default.stdout.write(w.default.green("F")),this.options.checkFormatted&&(d.default.stdout.write(`${e}
`),d.default.exitCode=1),this.formattedFiles.push(e)),a.length===0&&(this.options.progress||this.options.write)&&d.default.stdout.write(w.default.green(".")),Promise.resolve(t)}printFormattedOutput(e,t){this.options.write||this.options.checkFormatted||(d.default.stdout.write(`${t}`),f.default.last(this.paths)===e||f.default.last(this.targetFiles)===e)||(this.paths.length>1||this.targetFiles.length>1)&&d.default.stdout.write(`
`)}writeToFile(e,t){!this.options.write||this.options.checkFormatted||t.length===0||f.default.isNull(t)||f.default.isEmpty(t)||R.default.writeFile(e,t,n=>{n&&(d.default.stdout.write(`${w.default.red(n.message)}
`),d.default.exit(1))})}handleError(e,t){(this.options.progress||this.options.write)&&d.default.stdout.write(w.default.red("E")),d.default.exitCode=1,this.errors.push({path:e,message:t.message,error:t})}printPreamble(){this.options.checkFormatted&&d.default.stdout.write(`Check formatting... 
...
`;d.default.stdout.write(e),d.default.stdout.write(w.default.bold.green(`Fixed: F
`)),d.default.stdout.write(w.default.bold.red(`Errors: E
`)),d.default.stdout.write(w.default.bold("Not Changed: ")+w.default.bold.green(`.
`))}printFormattedFiles(){if(this.formattedFiles.length===0){this.options.checkFormatted&&d.default.stdout.write(w.default.bold(`
All matched files are formatted! 
`));return}if(!this.options.write){this.options.checkFormatted&&d.default.stdout.write(`
Above file(s) are formattable. Forgot to run formatter? Use ${w.default.bold("--write")} option to overwrite.
`);return}d.default.stdout.write(w.default.bold(`
Formatted Files: 
`)),f.default.each(this.formattedFiles,e=>d.default.stdout.write(`${w.default.bold(e)}
`))}printDifferences(){if(!!this.options.diff){if(d.default.stdout.write(w.default.bold(`
Differences: 

`)),f.default.filter(this.diffs,e=>e.length>0).length===0){d.default.stdout.write((0,w.default)(`No changes found. 

`));return}f.default.each(this.diffs,e=>le(e))}}printErrors(){f.default.isEmpty(this.errors)||(d.default.stdout.write(w.default.red.bold(`
Errors: 

`)),f.default.each(this.errors,e=>d.default.stdout.write(`${q.default.format(e)}
